...
public class Replica1Manager {
    ...
    public Replica1Manager(Logger logger) throws IOException {
        ...
        this.logger = logger;ReplicaId = "1";DeliveryNum = 0;SeqNumber = 0;
    ...
    public void startRMListener(int RMPort) throws Exception {
        ...
        byte[] data = null;
        logger.info("Replica1 Manager Start");
        while(true)
        {
            data = new byte[1024];
    ...
    public static void main(String[] args) throws Exception {
        ...
        Replica1Manager RM = new Replica1Manager(replicaLogger);
