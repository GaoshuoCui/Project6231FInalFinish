...
public class Replica3Manager {
    ...
    public Replica3Manager(Logger logger) throws IOException {
        ...
        this.logger = logger;ReplicaId = "3";DeliveryNum = 0;SeqNumber = 0;
    ...
    public void startRMListener(int RMPort) throws Exception {
        ...
        byte[] data = null;
        logger.info("Replica3 Manager Start");
        while(true)
        {
            data = new byte[1024];
    ...
    public static void main(String[] args) throws Exception {
        ...
        Replica3Manager RM = new Replica3Manager(replicaLogger);
